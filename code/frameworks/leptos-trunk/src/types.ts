...
import type { StorybookConfigVite, BuilderOptions } from '@storybook/builder-trunk';
import type docgenTypescript from '@joshwooding/vite-plugin-react-docgen-typescript';

type FrameworkName = '@storybook/leptos-trunk';
type BuilderName = '@storybook/builder-trunk';
